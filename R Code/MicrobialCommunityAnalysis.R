...
#Figure 3b
season.avg.genus138 <- ggarrange(spring.avg.genus138, summer.avg.genus138, fall.avg.genus138, winter.avg.genus138, nrow = 1, ncol = 4, common.legend = T, legend = "bottom")
season.avg.genus138
...
####Alpha Diversity Plots and ANOVAs####
